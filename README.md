...
| [mc_06_bvh_v1](examples/mc_06_bvh_v1) | Implement a single view virtual 3D scanner using [**BVH**](https://github.com/madmann91/bvh) ([v1](https://github.com/madmann91/bvh/tree/v1)) and **happly** (v2). | <img src="examples/mc_06_bvh_v1/bvh-virtual_3d_scanner-cropped.jpg" width=96px> |
